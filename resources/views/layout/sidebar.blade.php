...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <li><a href="{{url('studentdetails')}}"><i class="fa fa-home"></i>Student Details</a></li>

      <li><a href="{{url('studentregisterform')}}"><i class="fa fa-edit"></i>Student Registration</a></li>

      <li><a><i class="fa fa-desktop"></i>Cource <span class="fa fa-chevron-down"></span></a>
